...
export function GithubStarsButton({ username = 'zivhdinfo', repo = 'lazy-ui', className = '' }) {
  ...
  useEffect(() => {
    const fetchStars = async () => {
      try {
        ...
        console.error('Lỗi tải số sao GitHub:', e);
      }
    };
    fetchStars();
  }, [username, repo]);
  ...
  return (
    ...
    >
      ...
      {stars !== null && (
        <span className="github-count">{stars}</span>
      )}
    </a>
  );
}
